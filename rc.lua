...
memwidget:set_color({ type = "linear", from = { 0, 0 }, to = { 10,0 }, stops = { {0, "#FF5656"}, {50, "#88A175"},
                    {100, "#AECF96" }}})
vicious.register(memwidget, vicious.widgets.mem, "$1")
memmirror = wibox.layout.mirror()
memmirror:set_widget(memwidget)
memmirror:set_reflection({ vertical = true })
...
cpumirror = wibox.layout.mirror()
cpumirror:set_widget(cpuwidget)
cpumirror:set_reflection({ vertical = true })
...
for s = 1, screen.count() do
    ...
    -- right_layout:add(cpumirror)
    -- right_layout:add(memlabel)
    -- right_layout:add(memmirror)
...
globalkeys = awful.util.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.util.spawn(terminal .. " -e bash") end),
    ...
    awful.key({ modkey,           }, "]", function () awful.layout.inc(layouts, -1) end),
    awful.key({ modkey,           }, "#47", function () awful.layout.inc(layouts,  1) end),
    awful.key({ modkey,           }, "#48", function () awful.layout.inc(layouts, -1) end),
